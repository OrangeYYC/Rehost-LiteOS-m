...
IsIfaceActiveContext::IsIfaceActiveContext(napi_env env, EventManager *manager) : BaseContext(env, manager) {}

void IsIfaceActiveContext::ParseParams(napi_value *params, size_t paramsCount)
{
