...
void GetNetQuotaPoliciesContext::ParseParams(napi_value *params, size_t paramsCount)
{
...
bool GetNetQuotaPoliciesContext::CheckParamsType(napi_value *params, size_t paramsCount)
{
