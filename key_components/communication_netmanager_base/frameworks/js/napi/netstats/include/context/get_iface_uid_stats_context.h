...
#ifndef NETMANAGER_BASE_TSTATSGETIFACEUIDSTATS_CONTEXT_H
#define NETMANAGER_BASE_TSTATSGETIFACEUIDSTATS_CONTEXT_H
...
#endif // NETMANAGER_BASE_TSTATSGETIFACEUIDSTATS_CONTEXT_H
