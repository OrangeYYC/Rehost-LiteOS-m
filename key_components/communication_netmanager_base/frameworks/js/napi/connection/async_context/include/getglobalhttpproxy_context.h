...
#ifndef NETMANAGER_BASE_NAPI_GET_GLOBAL_HTTP_PROXY_H
#define NETMANAGER_BASE_NAPI_GET_GLOBAL_HTTP_PROXY_H
...
#endif // NETMANAGER_BASE_NAPI_GET_GLOBAL_HTTP_PROXY_H
